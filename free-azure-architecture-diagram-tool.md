...
- title: All icons included
  details: Icons for AWS, Azure, GCP, Kubernetes, CNCF and more are already available in the app. You don't have to search for & download icons & symbols separately.
- title: It's free
...
metaTitle: Free Azure Architecture Diagram Tool | CloudSkew
meta:
- name: 'og:image'
